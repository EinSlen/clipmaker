                ...
                <div className="space-y-6 p-5 sm:p-6">
                  ...
                  <details className="subpanel p-4">
                    ...
                    <div className="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                      {channel.game.id === "soft-body-slide" && <label className="space-y-1.5 text-xs text-ink-400 sm:col-span-2"><span>Playlist avec paroles anglaises</span><select className="field-control h-11" value={channel.game.musicProfile || "auto"} onChange={(event) => updateChannel(index, (item) => ({ ...item, game: { ...item.game, musicProfile: event.target.value as PublisherChannelConfig["game"]["musicProfile"] } }))}><option value="auto">Mix aléatoire — triste + revenge (9 titres)</option><option value="revenge">Revenge — sombre et puissant (5 titres)</option><option value="sad-english">Triste — chants en anglais (4 titres)</option><option value="original">Ambiance originale — sans paroles</option></select><p>Un titre différent chaque jour jusqu’à épuisement de la playlist. Crédit NCS inclus automatiquement.</p></label>}
